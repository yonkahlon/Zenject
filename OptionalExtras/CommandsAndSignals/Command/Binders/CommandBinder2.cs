...
namespace Zenject.Commands
{
        ...
        where TCommand : Command<TParam1, TParam2>
    {
        ...
        public ScopeBinder To<THandler>(Func<THandler, Action<TParam1, TParam2>> methodGetter)
        {
            Binding.Finalizer = new CommandBindingFinalizer<TCommand, THandler, TParam1, TParam2>(
                methodGetter,
