...
namespace Zenject
{
    ...
    public static class InstantiateUtil
    {
        ...
        public static List<TypeValuePair> CreateTypeValueListExplicit<T>(T param)
        {
        ...
        public static List<TypeValuePair> CreateTypeValueListExplicit<TParam1, TParam2>(TParam1 param1, TParam2 param2)
        {
            return new List<TypeValuePair>()
            {
        ...
        public static List<TypeValuePair> CreateTypeValueListExplicit<TParam1, TParam2, TParam3>(
        ...
        public static List<TypeValuePair> CreateTypeValueListExplicit<TParam1, TParam2, TParam3, TParam4>(
        ...
        public static List<TypeValuePair> CreateTypeValueListExplicit<TParam1, TParam2, TParam3, TParam4, TParam5>(
        ...
        public static List<TypeValuePair> CreateTypeValueListExplicit<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>(
