...
namespace Zenject
{
    ...
    public class IFactoryBinder<TParam1, TParam2, TContract>
        : IIFactoryBinder<TParam1, TParam2, TContract>
    {
            ...
            Func<DiContainer, TParam1, TParam2, TContract> method)
        {
            return _container.Bind<IFactory<TParam1, TParam2, TContract>>(_identifier)
                .ToMethod((c) => (_containerType == ContainerTypes.RuntimeContainer ? c.Container : _container).Instantiate<FactoryMethod<TParam1, TParam2, TContract>>(method));
        }
        ...
        public BindingConditionSetter ToFactory()
        {
            ...
            return _container.Bind<IFactory<TParam1, TParam2, TContract>>(_identifier)
                .ToTransient<Factory<TParam1, TParam2, TContract>>(_containerType);
        }
            ...
            return _container.Bind<IFactory<TParam1, TParam2, TContract>>(_identifier)
                .ToMethod(c =>
                    new FactoryNested<TParam1, TParam2, TContract, TConcrete>(
                        (_containerType == ContainerTypes.RuntimeContainer ? c.Container : _container).Instantiate<Factory<TParam1, TParam2, TConcrete>>()));
        }
            ...
            where TConcrete : TContract
        {
            return _container.Bind<IFactory<TParam1, TParam2, TContract>>(_identifier)
                .ToMethod(c =>
                    new FactoryNested<TParam1, TParam2, TContract, TConcrete>(
                        (_containerType == ContainerTypes.RuntimeContainer ? c.Container : _container).Resolve<IFactory<TParam1, TParam2, TConcrete>>()));
        }

        public BindingConditionSetter ToCustomFactory<TFactory>()
            where TFactory : IFactory<TParam1, TParam2, TContract>
        {
            return _container.Bind<IFactory<TParam1, TParam2, TContract>>(_identifier).ToTransient<TFactory>(_containerType);
        }
        ...
        public BindingConditionSetter ToPrefab(GameObject prefab)
        {
            ...
            return _container.Bind<IFactory<TParam1, TParam2, TContract>>(_identifier)
                .ToMethod((c) => (_containerType == ContainerTypes.RuntimeContainer ? c.Container : _container).Instantiate<MonoBehaviourFactory<TParam1, TParam2, TContract>>(prefab));
        }
#endif

        public BindingConditionSetter ToFacadeFactoryMethod<TFactory>(Action<DiContainer, TParam1, TParam2> facadeInstaller)
        ...
        public BindingConditionSetter ToFacadeFactoryMethod<TConcrete, TFactory>(Action<DiContainer, TParam1, TParam2> facadeInstaller)
            where TFactory : IFactory<TParam1, TParam2, TConcrete>, IFacadeFactory
            where TConcrete : TContract
        {
            return _container.Bind<IFactory<TParam1, TParam2, TContract>>(_identifier)
                .ToMethod(c => new FactoryNested<TParam1, TParam2, TContract, TConcrete>((_containerType == ContainerTypes.RuntimeContainer ? c.Container : _container).Instantiate<TFactory>(facadeInstaller)));
        }
            ...
            where TConcrete : TContract
        {
            ...
            return _container.Bind<IFactory<TParam1, TParam2, TContract>>(_identifier)
                .ToMethod(c => new FactoryNested<TParam1, TParam2, TContract, TConcrete>(
