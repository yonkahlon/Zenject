...
namespace Zenject
{
    ...
    public class IFactoryBinder<TParam1, TContract> : IIFactoryBinder<TParam1, TContract>
    {
            ...
            return _container.Bind<IFactory<TParam1, TContract>>(_identifier)
                .ToMethod(c =>
                    new FactoryNested<TParam1, TContract, TConcrete>(
                        c.Container.Instantiate<Factory<TParam1, TConcrete>>()));
        }
        ...
        {
            return _container.Bind<IFactory<TParam1, TContract>>(_identifier)
                .ToMethod(c => new FactoryNested<TParam1, TContract, TConcrete>(c.Container.Instantiate<TFactory>(facadeInstaller)));
        }
            ...
            where TConcrete : TContract
        {
            ...
            return _container.Bind<IFactory<TParam1, TContract>>(_identifier)
                .ToMethod(c => new FactoryNested<TParam1, TContract, TConcrete>(c.Container.Instantiate<TFactory>(installerType)));
        }
        ...
        public BindingConditionSetter ToPrefab(GameObject prefab)
        {
            ...
            return _container.Bind<IFactory<TParam1, TContract>>(_identifier)
                .ToMethod((ctx) => ctx.Container.Instantiate<MonoBehaviourFactory<TParam1, TContract>>(prefab));
        }
#endif
    }
}
