...
namespace Zenject
{
        ...
        where T : Component
    {
        ...
        public System.Collections.Generic.IEnumerable<ZenjectException> Validate()
        {
        ...
        where T : Component
    {
        ...
        public System.Collections.Generic.IEnumerable<ZenjectException> Validate()
        {
            return _container.ValidateObjectGraph<T>(new List<Type>() { typeof(P1) });
        }
    }
        ...
        where T : Component
    {
        ...
        public System.Collections.Generic.IEnumerable<ZenjectException> Validate()
        {
            return _container.ValidateObjectGraph<T>(new List<Type>() { typeof(P1), typeof(P2) });
        }
    }
        ...
        where T : Component
    {
        ...
        public System.Collections.Generic.IEnumerable<ZenjectException> Validate()
        {
            return _container.ValidateObjectGraph<T>(new List<Type>() { typeof(P1), typeof(P2), typeof(P3) });
        }
    }
        ...
        where T : Component
    {
        ...
        {
            return _container.ValidateObjectGraph<T>(
                new List<Type>() { typeof(P1), typeof(P2), typeof(P3), typeof(P4) });
        }
    }
}
