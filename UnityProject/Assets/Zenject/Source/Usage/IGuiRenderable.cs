namespace Zenject
{
    ...
    // `Container.Bind<GuiRenderer>().FromGameObject().NonLazy()` to an installer somewhere
    ...
    // `Container.Bind<GuiRenderer>().FromGameObject().AsSingle().NonLazy().CopyIntoAllSubContainers()`
